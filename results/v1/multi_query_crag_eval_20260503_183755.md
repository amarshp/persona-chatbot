...
- Generated: 2026-05-03 18:37:55Z
...
| lex | crag | outcome | page_rel - section_title |
| --- | ---- | ------- | ------------------------ |
| 4 | 2 | dropped | philosophy/strength_as_foundation.md - Key Events |
| 3 | 2 | dropped | decisions/jiao_san_team_selection.md - Key Events |
| 3 | 3 | dropped | philosophy/self_interest_and_human_nature.md - Key Events |
...
| 2 | 3 | dropped | decisions/talent_test_c_grade.md - Key Events |
...
- Candidate counts: retrieved=59, kept=51
- Diagnostic: right section included in formatted output
- Candidate judgements:
...
| 2 | 8 | kept | philosophy/demonic_path_survival.md - Key Events |
...
- Candidate counts: retrieved=90, kept=81
- Diagnostic: right section included in formatted output
- Candidate judgements:
...
| 1 | 2 | dropped | decisions/extortion_campaign.md - Connections |
| 1 | - | kept | decisions/extortion_campaign.md - Fang Yuan's Reasoning |
| 1 | - | kept | decisions/extortion_campaign.md - Summary |
| 1 | - | kept | decisions/liquor_worm_strategy.md - Summary |
| 1 | - | kept | decisions/shen_cui_confrontation.md - Summary |
...
- Candidate counts: retrieved=43, kept=32
...
- Candidate counts: retrieved=93, kept=84
- Diagnostic: right section included in formatted output
- Candidate judgements:
...
| 3 | 1 | dropped | events/beast_horde_survival.md - Key Events |
| 3 | 1 | dropped | philosophy/demonic_path_survival.md - Summary |
| 3 | - | kept | philosophy/self_interest_and_human_nature.md - Key Events |
| 3 | - | kept | relationships/fang_zheng.md - Key Events |
