...
- Generated: 2026-05-03 14:09:48Z
...
| lex | crag | outcome | page_rel - section_title |
| --- | ---- | ------- | ------------------------ |
| 4 | 7 | kept | philosophy/strength_as_foundation.md - Key Events |
...
| 3 | 2 | dropped | philosophy/strength_as_foundation.md - Summary |
...
- Candidate counts: retrieved=29, kept=21
- Diagnostic: right section included in formatted output
- Candidate judgements:
...
| 2 | 5 | dropped | decisions/jia_jin_sheng_killing.md - Key Events |
...
| 2 | 3 | dropped | decisions/jia_jin_sheng_killing.md - Fang Yuan's Reasoning |
...
| 3 | 3 | dropped | relationships/uncle_and_aunt.md - Key Events |
...
- Candidate counts: retrieved=18, kept=6
- Diagnostic: right section was retrieved but dropped by CRAG
- Candidate judgements:
...
| 2 | 3 | dropped | events/beast_horde_survival.md - Summary |
| 2 | 1 | dropped | events/flower_wine_monk_cave.md - Key Events |
| 2 | - | kept | events/hunter_family_killing.md - Key Events |
...
- Candidate counts: retrieved=47, kept=37
- Diagnostic: right section included in formatted output
- Candidate judgements:
