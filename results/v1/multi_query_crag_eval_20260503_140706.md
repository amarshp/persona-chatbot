...
- Generated: 2026-05-03 14:07:06Z
...
| 3 | 3 | dropped | philosophy/strength_as_foundation.md - Summary |
...
| 2 | 4 | dropped | events/hunter_family_killing.md - Fang Yuan's Reasoning |
...
| 2 | 6 | dropped | philosophy/demonic_path_survival.md - Summary |
...
- Candidate counts: retrieved=29, kept=19
- Diagnostic: right section was retrieved but dropped by CRAG
- Candidate judgements:

| lex | crag | outcome | page_rel - section_title |
| --- | ---- | ------- | ------------------------ |
| 4 | 8 | kept | philosophy/killing_logic.md - Key Contrast: Wang Da's Attack (Chapter 75) |
| 4 | 3 | dropped | philosophy/killing_logic.md - The Principle |
...
| 2 | 4 | dropped | decisions/liquor_worm_acquisition.md - Fang Yuan's Reasoning |
...
| 3 | 7 | kept | relationships/uncle_and_aunt.md - Key Events |
...
| 4 | 2 | dropped | decisions/liquor_worm_strategy.md - Key Events |
...
| 3 | 8 | kept | events/beast_horde_survival.md - Fang Yuan's Reasoning |
| 3 | 2 | dropped | events/beast_horde_survival.md - Key Events |
